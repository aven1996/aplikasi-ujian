<?php
    ...
    include "modules/login_petugas.php";
...
<div class="container text-center">
    <img src="assets/img/logo_full.svg" style="width: 150px; margin: 50px 0 50px 0;" alt="">
    ...
    <form action="" method="POST" style="width: 300px; margin:auto;" class="text-left">
        <div class="position-relative">
            ...
            <input name="user" type="text" class="form-control mb-2" style="padding-left: 40px;"  placeholder="Username" required>
        </div>
        <div class="position-relative">
        ...
        <button type="submit" class="btn btn-info w-100 mb-3" name="login_petugas">Log In</button>
        <small class="text-muted">Belum punya akun? <a href="#" data-toggle="modal" data-target="#akun_default">Lihat akun default</a></small>
    </form>
</div>
