...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Okt 2022 pada 13.23
...
(1, 'admin', '$2y$10$BBh5/Fqf1jR4l4uDvKFGW.0zTAyuOb7jykWr9CblKZcCEZr8NEbzO');
...
(1, 'US9KM', '2021-09-04', '00:00:00', '00:00:00', '-'),
(2, 'US6KT', '2021-09-04', '07:00:00', '09:00:00', 'Semua berjalan dengan baik'),
(4, 'USBLD', '2021-09-07', '00:00:00', '00:00:00', '-'),
(5, 'USRYE', '2022-08-10', '00:00:00', '00:00:00', '-');
...
(7, 'US6KT', '2021-08-12', '21:30:00', '23:00:00', 90),
(9, 'US9KM', '2021-08-12', '21:27:00', '23:00:00', 120),
(10, 'USBLD', '2021-09-04', '06:25:00', '23:01:00', 120),
(11, 'USRYE', '0000-00-00', '00:00:00', '00:00:00', 90);
...
(38, '021002', 'USRYE', 35, 150),
(39, '021005', 'USRYE', 35, 146);
...
(146, 35, 'Ya ada', ''),
(147, 35, 'tadi ada sih', ''),
(148, 35, 'tidak ada sama sekali', ''),
(149, 35, 'mudah dipahami', ''),
(150, 35, 'keren', '');
...
(35, 'USRYE', 'Apakah ada kendala dalam menjawab soal ini?', '', '146');
...
(78, '021002', 'USRYE', 'offline', 'Selesai', 33),
(79, '021005', 'USRYE', 'offline', 'Selesai', 0);
...
(4, 9, 9, 'US9KM', 'Ujian Selesai'),
(5, 10, 10, 'USBLD', 'Ujian Selesai'),
(6, 11, 11, 'USRYE', 'Ujian Berlangsung');
...
--
ALTER TABLE `tb_berita_acara`
  MODIFY `id_ba` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_guru_pengampu`
  MODIFY `id_pengampu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tb_jawaban`
  MODIFY `id_jwb` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `tb_nosoal`
  MODIFY `id_nosoal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT untuk tabel `tb_opsi_jwb`
--
ALTER TABLE `tb_opsi_jwb`
  MODIFY `id_opsi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;

--
-- AUTO_INCREMENT untuk tabel `tb_pengampu_jur`
--
ALTER TABLE `tb_pengampu_jur`
  MODIFY `id_pengampu_jur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `tb_siswa_ragu`
  MODIFY `id_ragu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT untuk tabel `tb_stt_siswa_login`
--
ALTER TABLE `tb_stt_siswa_login`
  MODIFY `id_siswa_login` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
